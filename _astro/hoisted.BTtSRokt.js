const _e="waxup-water-surface",et="(prefers-reduced-motion: reduce)",tt="(pointer: coarse)",xe="waxup:water-choreography",G="waxup-water-mood-v1",Ee="waxup-water-last-mood-v1",P=[{id:"tropical-glass",value:0},{id:"bay-fog",value:1},{id:"marine-layer",value:2},{id:"sunbreak",value:3}],ot=new Map([["tropical","tropical-glass"],["glass","tropical-glass"],["teal","tropical-glass"],["bay","bay-fog"],["fog","bay-fog"],["foggy","bay-fog"],["grey","bay-fog"],["gray","bay-fog"],["marine","marine-layer"],["overcast","marine-layer"],["pacific","marine-layer"],["sun","sunbreak"],["clear","sunbreak"]]);function $(e){if(!e)return null;const t=e.toLowerCase().trim(),n=ot.get(t)||t;return P.find(a=>a.id===n)||null}function Te(e,t){if(!e)return null;try{return e.getItem(t)}catch{return null}}function K(e,t,n){if(e)try{e.setItem(t,n)}catch{}}function Re(e){try{return window[e]}catch{return null}}function nt(e){if(window.crypto?.getRandomValues){const t=new Uint32Array(1);return window.crypto.getRandomValues(t),t[0]%e}return Math.floor(Math.random()*e)}function at(){const e=new URLSearchParams(window.location.search),t=$(e.get("water")||e.get("waterMood")),n=Re("sessionStorage"),a=Re("localStorage");if(t)return K(n,G,t.id),t;const r=$(Te(n,G));if(r)return r;const c=$(Te(a,Ee)),d=c?P.filter(s=>s.id!==c.id):P,l=d[nt(d.length)]||P[0];return K(n,G,l.id),K(a,Ee,l.id),l}const Ae=`
  ...
  `,rt=`
    ...
    void main() {
      ...
      float hullFlow = clamp(0.28 + velocityAmount * 0.62 + waveEnvelope * 0.48, 0.0, 1.35);
      ...
      next += (hullRim * 0.010 + leadingPressure * 0.020 + sidePressure * 0.004) * hullFlow;
      next -= leadingPressure * 0.006 * (1.0 - velocityAmount);
      ...
      next += (broadWave + broadTrough) * (0.040 + broadNoise * 0.012) * waveEnvelope * hullWaveGate;
  ...
  `,it=`
    ...
    void main() {
      ...
      float bigWaveLift = crestHighlight * 0.32 * hullWaveMask;
      float waveSplitSide = (
      ...
      float hullFlow = clamp(0.36 + velocityAmount * 0.54 + waveEnvelope * waveContactR * 0.70, 0.0, 1.35);
      ...
      float bowMotionR = clamp(bowAmbientR + velocityAmount * 0.72 + waveEnvelope * waveContactR * 0.95, 0.0, 1.0);
      ...
      color *= mix(1.0, 0.62, hullShadow * 0.33 + hullLeadingPressure * 0.16);
      color += moodCaustic * (hullRim * 0.16 + hullLeadingPressure * 0.24 + waveSplitSide * 0.18) * hullFlow;
      color += moodElectric * (hullSidePressure * 0.070 + waveSplitSide * 0.080) * hullFlow;
  ...
  `;function Le(e,t,n){const a=e.createShader(t);if(!a)throw new Error("Unable to create water shader.");if(e.shaderSource(a,n),e.compileShader(a),!e.getShaderParameter(a,e.COMPILE_STATUS)){const r=e.getShaderInfoLog(a)||"Unknown shader compile error.";throw e.deleteShader(a),new Error(r)}return a}function Se(e,t,n){const a=Le(e,e.VERTEX_SHADER,t),r=Le(e,e.FRAGMENT_SHADER,n),c=e.createProgram();if(!c)throw new Error("Unable to create water shader program.");if(e.attachShader(c,a),e.attachShader(c,r),e.linkProgram(c),e.deleteShader(a),e.deleteShader(r),!e.getProgramParameter(c,e.LINK_STATUS)){const d=e.getProgramInfoLog(c)||"Unknown shader link error.";throw e.deleteProgram(c),new Error(d)}return c}function st(e,t=P[0]){const n=window.matchMedia(tt).matches,a=n&&(navigator.hardwareConcurrency||8)<=4,r=n||a?256:512,c=t,d=document.createElement("canvas"),l={x:.5,y:.5,move:0,impulse:0,radius:32},s={stageProgress:0,stageInfluence:0,scrollVelocity:0,waveTravel:0,waveActive:!1,phone:{x:.5,y:.5,width:0,height:0}};let o=null,f=0,h=0,y=1,w=1,g=null,p=null,v=null,L=null,A=null,S=null,k=!1,B=!1;const b={},_={};d.setAttribute("aria-hidden","true"),d.className="water-canvas",e.textContent="",e.append(d);function U(){N(),q(),e.textContent="",e.dataset.fallback="true";const i=document.createElement("div");i.className="water-fallback",i.dataset.waterFallback="",e.append(i)}function ne(i,u){l.x=Math.min(Math.max(i/Math.max(window.innerWidth,1),0),1),l.y=1-Math.min(Math.max(u/Math.max(window.innerHeight,1),0),1)}function Ge(i){return i/Math.max(window.innerHeight,1)}function R(i,u=0,m=1){return Math.min(Math.max(Number.isFinite(i)?i:u,u),m)}function ae(i,u,m,T){ne(i,u),l.radius=m,l.move=Math.max(l.move,T)}function re(i,u,m,T){ne(i,u),l.radius=m,l.impulse=Math.max(l.impulse,T)}function ie(i,u){const m=o.createTexture(),T=o.createFramebuffer();if(!m||!T)throw new Error("Unable to create water render target.");o.bindTexture(o.TEXTURE_2D,m),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texImage2D(o.TEXTURE_2D,0,o.RGBA,i,i,0,o.RGBA,u,null),o.bindFramebuffer(o.FRAMEBUFFER,T),o.framebufferTexture2D(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,m,0);const C=o.checkFramebufferStatus(o.FRAMEBUFFER)===o.FRAMEBUFFER_COMPLETE;return{texture:m,framebuffer:T,complete:C}}function H(i){!o||!i||(o.deleteTexture(i.texture),o.deleteFramebuffer(i.framebuffer))}function se(i){const u=ie(r,i),m=ie(r,i);if(!(u.complete&&m.complete))return H(u),H(m),!1;A=u,S=m;for(const C of[A,S])o.bindFramebuffer(o.FRAMEBUFFER,C.framebuffer),o.viewport(0,0,r,r),o.clearColor(.5,.5,0,1),o.clear(o.COLOR_BUFFER_BIT);return!0}function $e(){const i=o.getExtension("OES_texture_half_float"),u=o.getExtension("EXT_color_buffer_half_float");return i&&u?i.HALF_FLOAT_OES:o.UNSIGNED_BYTE}function Ke(){b.state=o.getUniformLocation(p,"u_state"),b.texel=o.getUniformLocation(p,"u_texel"),b.pointer=o.getUniformLocation(p,"u_pointer"),b.aspect=o.getUniformLocation(p,"u_aspect"),b.strength=o.getUniformLocation(p,"u_strength"),b.radius=o.getUniformLocation(p,"u_radius"),b.phone=o.getUniformLocation(p,"u_phone"),b.choreo=o.getUniformLocation(p,"u_choreo"),_.state=o.getUniformLocation(v,"u_state"),_.texel=o.getUniformLocation(v,"u_texel"),_.resolution=o.getUniformLocation(v,"u_resolution"),_.time=o.getUniformLocation(v,"u_time"),_.mood=o.getUniformLocation(v,"u_mood"),_.phone=o.getUniformLocation(v,"u_phone"),_.choreo=o.getUniformLocation(v,"u_choreo")}function le(i){const u=o.getAttribLocation(i,"a_position");o.bindBuffer(o.ARRAY_BUFFER,L),o.enableVertexAttribArray(u),o.vertexAttribPointer(u,2,o.FLOAT,!1,0,0)}function O(){const i=Math.min(window.devicePixelRatio||1,n?1.5:2);y=Math.max(Math.floor(window.innerWidth*i),1),w=Math.max(Math.floor(window.innerHeight*i),1),(d.width!==y||d.height!==w)&&(d.width=y,d.height=w)}function Qe(i,u){o.bindFramebuffer(o.FRAMEBUFFER,S.framebuffer),o.viewport(0,0,r,r),o.useProgram(p),le(p),o.activeTexture(o.TEXTURE0),o.bindTexture(o.TEXTURE_2D,A.texture),o.uniform1i(b.state,0),o.uniform2f(b.texel,1/r,1/r),o.uniform2f(b.pointer,l.x,l.y),o.uniform1f(b.aspect,window.innerWidth/Math.max(window.innerHeight,1)),o.uniform1f(b.strength,i),o.uniform1f(b.radius,u),o.uniform4f(b.phone,s.phone.x,s.phone.y,s.phone.width,s.phone.height),o.uniform4f(b.choreo,s.stageProgress,s.stageInfluence,s.scrollVelocity,s.waveTravel),o.drawArrays(o.TRIANGLE_STRIP,0,4);const m=A;A=S,S=m}function je(i){o.bindFramebuffer(o.FRAMEBUFFER,null),o.viewport(0,0,y,w),o.useProgram(v),le(v),o.activeTexture(o.TEXTURE0),o.bindTexture(o.TEXTURE_2D,A.texture),o.uniform1i(_.state,0),o.uniform2f(_.texel,1/r,1/r),o.uniform2f(_.resolution,y,w),o.uniform1f(_.time,i),o.uniform1f(_.mood,c.value),o.uniform4f(_.phone,s.phone.x,s.phone.y,s.phone.width,s.phone.height),o.uniform4f(_.choreo,s.stageProgress,s.stageInfluence,s.scrollVelocity,s.waveTravel),o.drawArrays(o.TRIANGLE_STRIP,0,4)}function ce(i){if(document.hidden||k||B||!o){f=0;return}const u=i*.001,m=h?Math.min((i-h)*.001,.05):.016;h=i,O(),s.waveActive&&(s.waveTravel+=m/1.55,s.waveTravel>=1&&(s.waveActive=!1,s.waveTravel=0));const T=Math.min(l.move+l.impulse,.16),C=Ge(l.radius);Qe(T,C),je(u),l.move*=Math.pow(.035,m/.3),l.impulse*=Math.pow(.015,m/.1),s.scrollVelocity*=Math.pow(.03,m/.72),f=window.requestAnimationFrame(ce)}function W(){!f&&!document.hidden&&!k&&!B&&o&&(h=0,f=window.requestAnimationFrame(ce))}function N(){f&&(window.cancelAnimationFrame(f),f=0)}function q(){o&&(H(A),H(S),L&&o.deleteBuffer(L),p&&o.deleteProgram(p),v&&o.deleteProgram(v),A=null,S=null,L=null,p=null,v=null,o=null)}function ue(){if(o=d.getContext("webgl",{alpha:!1,antialias:!1,depth:!1,stencil:!1,powerPreference:"high-performance",preserveDrawingBuffer:!1}),!o)return!1;if(g=$e(),p=Se(o,Ae,rt),v=Se(o,Ae,it),L=o.createBuffer(),!L)throw new Error("Unable to create water vertex buffer.");if(o.bindBuffer(o.ARRAY_BUFFER,L),o.bufferData(o.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),o.STATIC_DRAW),!se(g)&&(g=o.UNSIGNED_BYTE,!se(g)))throw new Error("Unable to initialize water render targets.");return Ke(),O(),e.removeAttribute("data-fallback"),!0}function he(i){ae(i.clientX,i.clientY,30,.008)}let de=0;function fe(i){performance.now()-de<650||re(i.clientX,i.clientY,n?58:50,.028)}function me(i){const u=i.changedTouches[0];u&&(de=performance.now(),re(u.clientX,u.clientY,58,.03))}function ve(i){if(a)return;const u=i.changedTouches[0];u&&ae(u.clientX,u.clientY,48,.01)}function pe(){l.move=Math.min(l.move,.018)}function we(i){const u=i.detail||{},m=u.phone||{};s.stageProgress=R(u.stageProgress),s.stageInfluence=R(u.stageInfluence),s.scrollVelocity=R(u.scrollVelocity,-1,1),s.phone.x=R(m.x,-1,2),s.phone.y=R(m.y,-1,2),s.phone.width=R(m.width,0,2),s.phone.height=R(m.height,0,2),Number.isFinite(u.waveTravel)?(s.waveActive=!1,s.waveTravel=R(u.waveTravel)):R(u.waveKick)>.2&&(s.waveActive=!0,s.waveTravel=.001),W()}function ge(){if(document.hidden){N();return}W()}function be(i){i.preventDefault(),B=!0,N(),q()}function ye(){if(!k){B=!1;try{ue()?W():U()}catch(i){console.error("WaterSurface failed to restore WebGL.",i),U()}}}const x={passive:!0};function Je(){window.addEventListener("resize",O,x),document.addEventListener("mousemove",he,x),document.addEventListener("click",fe,x),document.addEventListener("touchstart",me,x),document.addEventListener("touchmove",ve,x),document.addEventListener("touchend",pe,x),document.addEventListener("visibilitychange",ge),window.addEventListener(xe,we),d.addEventListener("webglcontextlost",be),d.addEventListener("webglcontextrestored",ye)}function Ze(){window.removeEventListener("resize",O,x),document.removeEventListener("mousemove",he,x),document.removeEventListener("click",fe,x),document.removeEventListener("touchstart",me,x),document.removeEventListener("touchmove",ve,x),document.removeEventListener("touchend",pe,x),document.removeEventListener("visibilitychange",ge),window.removeEventListener(xe,we),d.removeEventListener("webglcontextlost",be),d.removeEventListener("webglcontextrestored",ye)}try{Je(),ue()?W():U()}catch(i){console.error("WaterSurface failed to initialize WebGL.",i),U()}return{destroy(){k=!0,N(),Ze(),q(),d.remove()}}}class lt extends HTMLElement{connectedCallback(){this.waterMood=at(),this.dataset.waterMood=this.waterMood.id,this.motionQuery=window.matchMedia(et),this.motionHandler=()=>this.syncMotionPreference(),this.motionQuery.addEventListener?this.motionQuery.addEventListener("change",this.motionHandler):this.motionQuery.addListener(this.motionHandler),this.syncMotionPreference()}disconnectedCallback(){this.motionQuery&&this.motionHandler&&(this.motionQuery.removeEventListener?this.motionQuery.removeEventListener("change",this.motionHandler):this.motionQuery.removeListener(this.motionHandler)),this.destroySurface()}syncMotionPreference(){if(this.motionQuery.matches){this.destroySurface(),this.dataset.reducedMotion="true",this.innerHTML='<div class="water-fallback" data-water-fallback></div>';return}delete this.dataset.reducedMotion,this.surface||(this.surface=st(this,this.waterMood||P[0]))}destroySurface(){this.surface&&(this.surface.destroy(),this.surface=null)}}customElements.get(_e)||customElements.define(_e,lt);const F="data-astro-transition-persist";function ct(e){for(const t of document.scripts)for(const n of e.scripts)if(!n.hasAttribute("data-astro-rerun")&&(!t.src&&t.textContent===n.textContent||t.src&&t.type===n.type&&t.src===n.src)){n.dataset.astroExec="";break}}function ut(e){const t=document.documentElement,n=[...t.attributes].filter(({name:a})=>(t.removeAttribute(a),a.startsWith("data-astro-")));[...e.documentElement.attributes,...n].forEach(({name:a,value:r})=>t.setAttribute(a,r))}function ht(e){for(const t of Array.from(document.head.children)){const n=mt(t,e);n?n.remove():t.remove()}document.head.append(...e.head.children)}function dt(e,t){t.replaceWith(e);for(const n of t.querySelectorAll(`[${F}]`)){const a=n.getAttribute(F),r=e.querySelector(`[${F}="${a}"]`);r&&(r.replaceWith(n),r.localName==="astro-island"&&vt(n)&&!pt(n,r)&&(n.setAttribute("ssr",""),n.setAttribute("props",r.getAttribute("props"))))}}const ft=()=>{const e=document.activeElement;if(e?.closest(`[${F}]`)){if(e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement){const t=e.selectionStart,n=e.selectionEnd;return()=>Q({activeElement:e,start:t,end:n})}return()=>Q({activeElement:e})}else return()=>Q({activeElement:null})},Q=({activeElement:e,start:t,end:n})=>{e&&(e.focus(),(e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement)&&(typeof t=="number"&&(e.selectionStart=t),typeof n=="number"&&(e.selectionEnd=n)))},mt=(e,t)=>{const n=e.getAttribute(F),a=n&&t.head.querySelector(`[${F}="${n}"]`);if(a)return a;if(e.matches("link[rel=stylesheet]")){const r=e.getAttribute("href");return t.head.querySelector(`link[rel=stylesheet][href="${r}"]`)}return null},vt=e=>{const t=e.dataset.astroTransitionPersistProps;return t==null||t==="false"},pt=(e,t)=>e.getAttribute("props")===t.getAttribute("props"),wt=e=>{ct(e),ut(e),ht(e);const t=ft();dt(e.body,document.body),t()},gt="astro:before-preparation",bt="astro:after-preparation",yt="astro:before-swap",_t="astro:after-swap",xt=e=>document.dispatchEvent(new Event(e));class Ue extends Event{from;to;direction;navigationType;sourceElement;info;newDocument;signal;constructor(t,n,a,r,c,d,l,s,o,f){super(t,n),this.from=a,this.to=r,this.direction=c,this.navigationType=d,this.sourceElement=l,this.info=s,this.newDocument=o,this.signal=f,Object.defineProperties(this,{from:{enumerable:!0},to:{enumerable:!0,writable:!0},direction:{enumerable:!0,writable:!0},navigationType:{enumerable:!0},sourceElement:{enumerable:!0},info:{enumerable:!0},newDocument:{enumerable:!0,writable:!0},signal:{enumerable:!0}})}}class Et extends Ue{formData;loader;constructor(t,n,a,r,c,d,l,s,o,f){super(gt,{cancelable:!0},t,n,a,r,c,d,l,s),this.formData=o,this.loader=f.bind(this,this),Object.defineProperties(this,{formData:{enumerable:!0},loader:{enumerable:!0,writable:!0}})}}class Tt extends Ue{direction;viewTransition;swap;constructor(t,n){super(yt,void 0,t.from,t.to,t.direction,t.navigationType,t.sourceElement,t.info,t.newDocument,t.signal),this.direction=t.direction,this.viewTransition=n,this.swap=()=>wt(this.newDocument),Object.defineProperties(this,{direction:{enumerable:!0},viewTransition:{enumerable:!0},swap:{enumerable:!0,writable:!0}})}}async function Rt(e,t,n,a,r,c,d,l,s){const o=new Et(e,t,n,a,r,c,window.document,d,l,s);return document.dispatchEvent(o)&&(await o.loader(),o.defaultPrevented||(xt(bt),o.navigationType!=="traverse"&&Z({scrollX,scrollY}))),o}function At(e,t){const n=new Tt(e,t);return document.dispatchEvent(n),n.swap(),n}const Lt=history.pushState.bind(history),X=history.replaceState.bind(history),Z=e=>{history.state&&(history.scrollRestoration="manual",X({...history.state,...e},""))},ee=!!document.startViewTransition,te=()=>!!document.querySelector('[name="astro-view-transitions-enabled"]'),He=(e,t)=>e.pathname===t.pathname&&e.search===t.search;let E,D,Y;const Oe=e=>document.dispatchEvent(new Event(e)),We=()=>Oe("astro:page-load"),St=()=>{let e=document.createElement("div");e.setAttribute("aria-live","assertive"),e.setAttribute("aria-atomic","true"),e.className="astro-route-announcer",document.body.append(e),setTimeout(()=>{let t=document.title||document.querySelector("h1")?.textContent||location.pathname;e.textContent=t},60)},De="data-astro-transition-persist",Pe="data-astro-transition",j="data-astro-transition-fallback";let Fe,M=0;history.state?(M=history.state.index,scrollTo({left:history.state.scrollX,top:history.state.scrollY})):te()&&(X({index:M,scrollX,scrollY},""),history.scrollRestoration="manual");async function Dt(e,t){try{const n=await fetch(e,t),r=(n.headers.get("content-type")??"").split(";",1)[0].trim();return r!=="text/html"&&r!=="application/xhtml+xml"?null:{html:await n.text(),redirected:n.redirected?n.url:void 0,mediaType:r}}catch{return null}}function Ne(){const e=document.querySelector('[name="astro-view-transitions-fallback"]');return e?e.getAttribute("content"):"animate"}function Pt(){let e=Promise.resolve();for(const t of document.getElementsByTagName("script")){if(t.dataset.astroExec==="")continue;const n=t.getAttribute("type");if(n&&n!=="module"&&n!=="text/javascript")continue;const a=document.createElement("script");a.innerHTML=t.innerHTML;for(const r of t.attributes){if(r.name==="src"){const c=new Promise(d=>{a.onload=a.onerror=d});e=e.then(()=>c)}a.setAttribute(r.name,r.value)}a.dataset.astroExec="",t.replaceWith(a)}return e}const Xe=(e,t,n,a,r)=>{const c=He(t,e),d=document.title;document.title=a;let l=!1;if(e.href!==location.href&&!r)if(n.history==="replace"){const s=history.state;X({...n.state,index:s.index,scrollX:s.scrollX,scrollY:s.scrollY},"",e.href)}else Lt({...n.state,index:++M,scrollX:0,scrollY:0},"",e.href);if(document.title=d,Y=e,c||(scrollTo({left:0,top:0,behavior:"instant"}),l=!0),r)scrollTo(r.scrollX,r.scrollY);else{if(e.hash){history.scrollRestoration="auto";const s=history.state;location.href=e.href,history.state||(X(s,""),c&&window.dispatchEvent(new PopStateEvent("popstate")))}else l||scrollTo({left:0,top:0,behavior:"instant"});history.scrollRestoration="manual"}};function Ft(e){const t=[];for(const n of e.querySelectorAll("head link[rel=stylesheet]"))if(!document.querySelector(`[${De}="${n.getAttribute(De)}"], link[rel=stylesheet][href="${n.getAttribute("href")}"]`)){const a=document.createElement("link");a.setAttribute("rel","preload"),a.setAttribute("as","style"),a.setAttribute("href",n.getAttribute("href")),t.push(new Promise(r=>{["load","error"].forEach(c=>a.addEventListener(c,r)),document.head.append(a)}))}return t}async function Ce(e,t,n,a,r){async function c(s){function o(w){const g=w.effect;return!g||!(g instanceof KeyframeEffect)||!g.target?!1:window.getComputedStyle(g.target,g.pseudoElement).animationIterationCount==="infinite"}const f=document.getAnimations();document.documentElement.setAttribute(j,s);const y=document.getAnimations().filter(w=>!f.includes(w)&&!o(w));return Promise.allSettled(y.map(w=>w.finished))}if(r==="animate"&&!n.transitionSkipped&&!e.signal.aborted)try{await c("old")}catch{}const d=document.title,l=At(e,n.viewTransition);Xe(l.to,l.from,t,d,a),Oe(_t),r==="animate"&&(!n.transitionSkipped&&!l.signal.aborted?c("new").finally(()=>n.viewTransitionFinished()):n.viewTransitionFinished())}function Ct(){return E?.controller.abort(),E={controller:new AbortController}}async function ze(e,t,n,a,r){const c=Ct();if(!te()||location.origin!==n.origin){c===E&&(E=void 0),location.href=n.href;return}const d=r?"traverse":a.history==="replace"?"replace":"push";if(d!=="traverse"&&Z({scrollX,scrollY}),He(t,n)&&(e!=="back"&&n.hash||e==="back"&&t.hash)){Xe(n,t,a,document.title,r),c===E&&(E=void 0);return}const l=await Rt(t,n,e,d,a.sourceElement,a.info,c.controller.signal,a.formData,s);if(l.defaultPrevented||l.signal.aborted){c===E&&(E=void 0),l.signal.aborted||(location.href=n.href);return}async function s(h){const y=h.to.href,w={signal:h.signal};if(h.formData){w.method="POST";const v=h.sourceElement instanceof HTMLFormElement?h.sourceElement:h.sourceElement instanceof HTMLElement&&"form"in h.sourceElement?h.sourceElement.form:h.sourceElement?.closest("form");w.body=v?.attributes.getNamedItem("enctype")?.value==="application/x-www-form-urlencoded"?new URLSearchParams(h.formData):h.formData}const g=await Dt(y,w);if(g===null){h.preventDefault();return}if(g.redirected){const v=new URL(g.redirected);if(v.origin!==h.to.origin){h.preventDefault();return}h.to=v}if(Fe??=new DOMParser,h.newDocument=Fe.parseFromString(g.html,g.mediaType),h.newDocument.querySelectorAll("noscript").forEach(v=>v.remove()),!h.newDocument.querySelector('[name="astro-view-transitions-enabled"]')&&!h.formData){h.preventDefault();return}const p=Ft(h.newDocument);p.length&&!h.signal.aborted&&await Promise.all(p)}async function o(){if(D&&D.viewTransition){try{D.viewTransition.skipTransition()}catch{}try{await D.viewTransition.updateCallbackDone}catch{}}return D={transitionSkipped:!1}}const f=await o();if(l.signal.aborted){c===E&&(E=void 0);return}if(document.documentElement.setAttribute(Pe,l.direction),ee)f.viewTransition=document.startViewTransition(async()=>await Ce(l,a,f,r));else{const h=(async()=>{await Promise.resolve(),await Ce(l,a,f,r,Ne())})();f.viewTransition={updateCallbackDone:h,ready:h,finished:new Promise(y=>f.viewTransitionFinished=y),skipTransition:()=>{f.transitionSkipped=!0,document.documentElement.removeAttribute(j)}}}f.viewTransition?.updateCallbackDone.finally(async()=>{await Pt(),We(),St()}),f.viewTransition?.finished.finally(()=>{f.viewTransition=void 0,f===D&&(D=void 0),c===E&&(E=void 0),document.documentElement.removeAttribute(Pe),document.documentElement.removeAttribute(j)});try{await f.viewTransition?.updateCallbackDone}catch(h){const y=h;console.log("[astro]",y.name,y.message,y.stack)}}async function Me(e,t){await ze("forward",Y,new URL(e,location.href),t??{})}function Mt(e){if(!te()&&e.state){location.reload();return}if(e.state===null)return;const t=history.state,n=t.index,a=n>M?"forward":"back";M=n,ze(a,Y,new URL(location.href),{},t)}const Ie=()=>{history.state&&(scrollX!==history.state.scrollX||scrollY!==history.state.scrollY)&&Z({scrollX,scrollY})};{if(ee||Ne()!=="none")if(Y=new URL(location.href),addEventListener("popstate",Mt),addEventListener("load",We),"onscrollend"in window)addEventListener("scrollend",Ie);else{let e,t,n,a;const r=()=>{if(a!==history.state?.index){clearInterval(e),e=void 0;return}if(t===scrollY&&n===scrollX){clearInterval(e),e=void 0,Ie();return}else t=scrollY,n=scrollX};addEventListener("scroll",()=>{e===void 0&&(a=history.state?.index,t=scrollY,n=scrollX,e=window.setInterval(r,50))},{passive:!0})}for(const e of document.getElementsByTagName("script"))e.dataset.astroExec=""}const Ye=new Set,z=new WeakSet;let J,Ve,ke=!1;function It(e){ke||(ke=!0,J??=e?.prefetchAll,Ve??=e?.defaultStrategy??"hover",kt(),Bt(),Ut(),Ot())}function kt(){for(const e of["touchstart","mousedown"])document.body.addEventListener(e,t=>{I(t.target,"tap")&&V(t.target.href,{ignoreSlowConnection:!0})},{passive:!0})}function Bt(){let e;document.body.addEventListener("focusin",a=>{I(a.target,"hover")&&t(a)},{passive:!0}),document.body.addEventListener("focusout",n,{passive:!0}),oe(()=>{for(const a of document.getElementsByTagName("a"))z.has(a)||I(a,"hover")&&(z.add(a),a.addEventListener("mouseenter",t,{passive:!0}),a.addEventListener("mouseleave",n,{passive:!0}))});function t(a){const r=a.target.href;e&&clearTimeout(e),e=setTimeout(()=>{V(r)},80)}function n(){e&&(clearTimeout(e),e=0)}}function Ut(){let e;oe(()=>{for(const t of document.getElementsByTagName("a"))z.has(t)||I(t,"viewport")&&(z.add(t),e??=Ht(),e.observe(t))})}function Ht(){const e=new WeakMap;return new IntersectionObserver((t,n)=>{for(const a of t){const r=a.target,c=e.get(r);a.isIntersecting?(c&&clearTimeout(c),e.set(r,setTimeout(()=>{n.unobserve(r),e.delete(r),V(r.href)},300))):c&&(clearTimeout(c),e.delete(r))}})}function Ot(){oe(()=>{for(const e of document.getElementsByTagName("a"))I(e,"load")&&V(e.href)})}function V(e,t){e=e.replace(/#.*/,"");const n=t?.ignoreSlowConnection??!1;if(Wt(e,n))if(Ye.add(e),document.createElement("link").relList?.supports?.("prefetch")&&t?.with!=="fetch"){const a=document.createElement("link");a.rel="prefetch",a.setAttribute("href",e),document.head.append(a)}else fetch(e,{priority:"low"})}function Wt(e,t){if(!navigator.onLine||!t&&qe())return!1;try{const n=new URL(e,location.href);return location.origin===n.origin&&(location.pathname!==n.pathname||location.search!==n.search)&&!Ye.has(e)}catch{}return!1}function I(e,t){if(e?.tagName!=="A")return!1;const n=e.dataset.astroPrefetch;return n==="false"?!1:t==="tap"&&(n!=null||J)&&qe()?!0:n==null&&J||n===""?t===Ve:n===t}function qe(){if("connection"in navigator){const e=navigator.connection;return e.saveData||/2g/.test(e.effectiveType)}return!1}function oe(e){e();let t=!1;document.addEventListener("astro:page-load",()=>{if(!t){t=!0;return}e()})}function Nt(){const e=document.querySelector('[name="astro-view-transitions-fallback"]');return e?e.getAttribute("content"):"animate"}function Be(e){return e.dataset.astroReload!==void 0}(ee||Nt()!=="none")&&(document.addEventListener("click",e=>{let t=e.target;if(e.composed&&(t=e.composedPath()[0]),t instanceof Element&&(t=t.closest("a, area")),!(t instanceof HTMLAnchorElement)&&!(t instanceof SVGAElement)&&!(t instanceof HTMLAreaElement))return;const n=t instanceof HTMLElement?t.target:t.target.baseVal,a=t instanceof HTMLElement?t.href:t.href.baseVal,r=new URL(a,location.href).origin;Be(t)||t.hasAttribute("download")||!t.href||n&&n!=="_self"||r!==location.origin||e.button!==0||e.metaKey||e.ctrlKey||e.altKey||e.shiftKey||e.defaultPrevented||(e.preventDefault(),Me(a,{history:t.dataset.astroHistory==="replace"?"replace":"auto",sourceElement:t}))}),document.addEventListener("submit",e=>{let t=e.target;if(t.tagName!=="FORM"||e.defaultPrevented||Be(t))return;const n=t,a=e.submitter,r=new FormData(n,a),c=typeof n.action=="string"?n.action:n.getAttribute("action"),d=typeof n.method=="string"?n.method:n.getAttribute("method");let l=a?.getAttribute("formaction")??c??location.pathname;const s=a?.getAttribute("formmethod")??d??"get";if(s==="dialog"||location.origin!==new URL(l,location.href).origin)return;const o={sourceElement:a??n};if(s==="get"){const f=new URLSearchParams(r),h=new URL(l);h.search=f.toString(),l=h.toString()}else o.formData=r;e.preventDefault(),Me(l,o)}),It({prefetchAll:!0}));
